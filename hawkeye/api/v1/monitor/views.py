...
class DreamViewSet(BulkModelViewSet):
    ...
    def claim(self, request, *args, **kwargs):
        ...
        message = f'【万人圆梦】亲爱的{full_name}，{dream.person_name}的微心愿已经被{donor_name}认领，联系方式:{phone_num}。希望您在24小时内与微心愿认领人{donor_name}取得联系，开展好后续的微心愿送达工作，并做好送达过程照片和送达纸质单据的留存和逐级上报工作（共青团宁波市委）。'
